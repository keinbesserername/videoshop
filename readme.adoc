...
This project is a fork of https://github.com/st-tu-dresden/videoshop  where it is used to make students 
familiar with basic technologies they're going to use during the Software Engineering Lab at TU Dresden.
...
NOTE: The Quickstart requires Java 11 and a recent Git (2.20 or newer preferred) to be available on your machine. 
...
https://adoptium.net/?variant=openjdk11&jvmVariant=hotspot[Download] the binaries, install. 
